...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { email: @administrator.email, name: @administrator.name, password: @administrator.password }
    end
  ...
  test "should update administrator" do
    patch :update, id: @administrator, administrator: { email: @administrator.email, name: @administrator.name, password: @administrator.password }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
